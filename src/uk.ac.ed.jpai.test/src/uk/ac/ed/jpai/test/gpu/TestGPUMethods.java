...
public class TestGPUMethods extends MarawaccOpenCLTestBase {

    private static Integer computation(Integer x) {
        return x + 10;
    }
    ...
    public void testMethods() {
        ...
        ArrayFunction<Integer, Integer> function = new MapAccelerator<>(TestGPUMethods::computation);
        ...
        for (int i = 0; i < output.size(); i++) {
            assertEquals(input.get(i) + 10, output.get(i), 0.001);
        }
