...
public class Tuple10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> extends Tuple {
    ...
    public RuntimeObjectTypeInfo getType() {
        return new RuntimeObjectTypeInfo(Tuple10.class, new RuntimeObjectTypeInfo(this._1.getClass()), new RuntimeObjectTypeInfo(this._2.getClass()), new RuntimeObjectTypeInfo(this._3.getClass()),
                        new RuntimeObjectTypeInfo(this._4.getClass()), new RuntimeObjectTypeInfo(this._5.getClass()), new RuntimeObjectTypeInfo(this._6.getClass()), new RuntimeObjectTypeInfo(
                                        this._7.getClass()), new RuntimeObjectTypeInfo(this._8.getClass()), new RuntimeObjectTypeInfo(this._9.getClass()), new RuntimeObjectTypeInfo(
                                        this._10.getClass()));
    }
