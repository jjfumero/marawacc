...
public class Tuple7<T, R, U, V, W, X, Y> extends Tuple {
    ...
    public Tuple7(T _1, R _2, U _3, V _4, W _5, X _6, Y _7) {
        super();
        this._1 = _1;
        this._2 = _2;
        this._3 = _3;
    ...
    public RuntimeObjectTypeInfo getType() {
        return new RuntimeObjectTypeInfo(Tuple7.class, new RuntimeObjectTypeInfo(this._1.getClass()), new RuntimeObjectTypeInfo(this._2.getClass()), new RuntimeObjectTypeInfo(this._3.getClass()),
